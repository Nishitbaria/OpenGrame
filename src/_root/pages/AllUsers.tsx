...
const AllUsers = () => {
  ...
  console.log("the seach key value ", debouncedSearch);

  const { data: searchedUsers, isFetching: isSearchFetching, isError } = useSearchUsers(debouncedSearch);
  console.log("the searched users query error ", isError);
      ...
      <div className="user-container">
        ...
        {isLoading && !creators ? (
          ...
          !isError ? (
            ...
            <ul className="user-grid">
              {creators?.documents.filter((user) => user.username.includes(searchValue)).map((creator) => (
