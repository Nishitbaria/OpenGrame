...
export default function Story({ user, isYourStory }: StoryProps) {
  return (
    <>
      <Dialog>
        <li className="flex flex-none flex-col items-center space-y-1">
          <DialogTrigger>
            <div
              className={`relative ${
                user.isUpdate
                  ? "bg-gradient-to-tr from-blue-400 to-fuchsia-600 "
                  : ""
              } p-1 rounded-full`}
            >
              <img
          ...
          <Link to="#" className="text-xs text-white-800 font-semibold">
